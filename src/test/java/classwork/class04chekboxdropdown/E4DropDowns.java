...
public class E4DropDowns extends CommonMethods {
...
//     2.create an object of the select class and pass "days" as parameter to find the dropdown element of choice
